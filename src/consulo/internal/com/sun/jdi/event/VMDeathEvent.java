 ...
 * {@link consulo.internal.com.sun.jdi.VirtualMachine#dispose()
 *      VirtualMachine.dispose()}
 * <P>
 * On VM termination, a single unsolicited VMDeathEvent
 * will always be sent with a
 * {@link consulo.internal.com.sun.jdi.request.EventRequest#suspendPolicy() suspend policy}
 * of {@link consulo.internal.com.sun.jdi.request.EventRequest#SUSPEND_NONE SUSPEND_NONE}.
 * Additional VMDeathEvents will be sent in the same event set if they are
 * requested with a
 * {@link consulo.internal.com.sun.jdi.request.VMDeathRequest VMDeathRequest}.
 * <P>
 ...
 * @see consulo.internal.com.sun.jdi.request.VMDeathRequest
 * @see EventQueue
 * @see VirtualMachine
 *
 * @author Robert Field
