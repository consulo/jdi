...
import consulo.internal.com.sun.jdi.connect.spi.*;
        ...
        extends ConnectorImpl implements AttachingConnector
{
    ...
    consulo.internal.com.sun.tools.attach.VirtualMachine vm;
    Transport transport;
                ...
                throws IOException, IllegalConnectorArgumentsException
    {
        ...
        String address = null;
        consulo.internal.com.sun.tools.attach.VirtualMachine vm = null;
        try {
            vm = consulo.internal.com.sun.tools.attach.VirtualMachine.attach(pid);
        ...
        if (lib.equals("dt_socket")) {
            ...
            if (lib.equals("dt_shmem")) {
                try {
                    Class<?> c = Class.forName("consulo.internal.com.sun.tools.jdi.SharedMemoryTransportService");
    ...
    public String name() {
        return "consulo.internal.com.sun.jdi.ProcessAttach";
    }
