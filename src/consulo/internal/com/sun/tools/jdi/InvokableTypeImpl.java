...
abstract class InvokableTypeImpl extends ReferenceTypeImpl
{
	 ...
	 */
	final public Value invokeMethod(ThreadReference threadIntf,
			Method methodIntf,
	...
	private PacketStream sendInvokeCommand(final ThreadReferenceImpl thread, final MethodImpl method, final ValueImpl[] args, final int options)
	{
