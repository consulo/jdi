...
import consulo.internal.com.sun.jdi.JDIPermission;
...
import consulo.internal.com.sun.jdi.connect.LaunchingConnector;
...
/* Public for use by consulo.internal.com.sun.jdi.Bootstrap */
public class VirtualMachineManagerImpl implements VirtualMachineManagerService {
    ...
    protected VirtualMachineManagerImpl() {
        ...
        // "consulo.internal.com.sun.jdi.CommandLineLaunch". If this connector
        ...
        for (LaunchingConnector lc: launchers) {
            if (lc.name().equals("consulo.internal.com.sun.jdi.CommandLineLaunch")) {
    ...
    String getString(String key) {
        if (messages == null) {
            messages = ResourceBundle.getBundle("consulo.internal.com.sun.tools.jdi.resources.jdi");
        }
