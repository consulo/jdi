 ...
 * {@link consulo.internal.com.sun.jdi.request.BreakpointRequest}).
 ...
 * <p>
 * Any method on a {@link consulo.internal.com.sun.jdi.Mirror} that takes a <code>Mirror</code> as an
 * parameter directly or indirectly (e.g., as a element in a <code>List</code>) will
 * throw {@link consulo.internal.com.sun.jdi.VMMismatchException} if the mirrors are from different
 * virtual machines.
 *
 * @see VirtualMachine
 *
