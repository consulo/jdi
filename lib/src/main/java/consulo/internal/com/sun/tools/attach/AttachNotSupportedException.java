...
import consulo.internal.com.sun.tools.attach.spi.AttachProvider;         // for javadoc

/**
 * Thrown by {@link consulo.internal.com.sun.tools.attach.VirtualMachine#attach
 * VirtalMachine.attach} when attempting to attach to a Java virtual machine
 * for which a compatible {@link consulo.internal.com.sun.tools.attach.spi.AttachProvider
 * AttachProvider} does not exist. It is also thrown by {@link
 * consulo.internal.com.sun.tools.attach.spi.AttachProvider#attachVirtualMachine
