 ...
 * {@link consulo.internal.com.sun.jdi.connect.Connector}. For example,
 * an {@link consulo.internal.com.sun.jdi.connect.AttachingConnector AttachingConnector}
 ...
 * consulo.internal.com.sun.jdi.VirtualMachineManager#createVirtualMachine(Connection)}
 * createVirtualMachine(Connection) method.
 * <p>
 * Note that a target VM launched by a launching connector is not
 * guaranteed to be stable until after the {@link consulo.internal.com.sun.jdi.event.VMStartEvent} has been
 * received.
 * <p>
 * Any method on <code>VirtualMachine</code> which
 * takes <code>VirtualMachine</code> as an parameter may throw
 * {@link consulo.internal.com.sun.jdi.VMDisconnectedException} if the target VM is
 * disconnected and the {@link consulo.internal.com.sun.jdi.event.VMDisconnectEvent} has been or is
 * available to be read from the {@link consulo.internal.com.sun.jdi.event.EventQueue}.
 * <p>
 * Any method on <code>VirtualMachine</code> which
 * takes <code>VirtualMachine</code> as an parameter may throw
 * {@link consulo.internal.com.sun.jdi.VMOutOfMemoryException} if the target VM has run out of memory.
 *
 * @author Robert Field
...
public interface VirtualMachine extends Mirror {
     ...
     * by a {@link consulo.internal.com.sun.jdi.connect.LaunchingConnector}
     *
     * @return the {@link java.lang.Process} object for this virtual
     * machine, or null if it was not launched by a
     * {@link consulo.internal.com.sun.jdi.connect.LaunchingConnector}.
     * @throws VMCannotBeModifiedException if the VirtualMachine is read-only
     * -see {@link VirtualMachine#canBeModified()}.
     */
    Process process();
     ...
     * see {@link consulo.internal.com.sun.jdi.request.BreakpointRequest#addInstanceFilter}.
     *
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     */
     ...
     * {@link consulo.internal.com.sun.jdi.request.VMDeathRequest}s.
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createVMDeathRequest
     *
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     *
     ...
     * in
     * {@link consulo.internal.com.sun.jdi.event.MethodExitEvent}s.
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createMethodExitRequest
     *
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     *
     ...
     *
     * see {@link consulo.internal.com.sun.jdi.request.ClassPrepareRequest#addSourceNameFilter}.
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     *
     * @since 1.6
    ...
    /**
     * Determines if the target VM supports the creation of
     * {@link consulo.internal.com.sun.jdi.request.MonitorContendedEnterRequest}s.
     * {@link consulo.internal.com.sun.jdi.request.MonitorContendedEnteredRequest}s.
     * {@link consulo.internal.com.sun.jdi.request.MonitorWaitRequest}s.
     * {@link consulo.internal.com.sun.jdi.request.MonitorWaitedRequest}s.
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createMonitorContendedEnterRequest
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createMonitorContendedEnteredRequest
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createMonitorWaitRequest
     * @see consulo.internal.com.sun.jdi.request.EventRequestManager#createMonitorWaitedRequest
     *
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     *
     ...
     * @see consulo.internal.com.sun.jdi.ThreadReference#ownedMonitorsAndFrames
     *
     * @return <code>true</code> if the feature is supported,
     * <code>false</code> otherwise.
     *
    ...
    /**
     * Traces the activities performed by the consulo.internal.com.sun.jdi implementation.
