 ...
 * consulo.internal.com.sun.jdi.connect.spi.TransportService TransportService}
 * implementations this exception is thrown when
 * {@link consulo.internal.com.sun.jdi.connect.spi.TransportService#attach attach}
 * times out when establishing a connection to a target VM,
 * or {@link consulo.internal.com.sun.jdi.connect.spi.TransportService#accept
 * accept} times out while waiting for a target VM to connect. </p>
 *
 * @see AttachingConnector#attach
 * @see ListeningConnector#accept
 * @see consulo.internal.com.sun.jdi.connect.spi.TransportService#attach
 * @see consulo.internal.com.sun.jdi.connect.spi.TransportService#accept
 *
 * @since 1.5
 */
