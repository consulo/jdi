 ...
 * There is no corresponding {@link consulo.internal.com.sun.jdi.request.EventRequest}.
 * The enclosing singleton {@link EventSet} always has a
 * suspend policy of {@link consulo.internal.com.sun.jdi.request.EventRequest#SUSPEND_NONE}.
 *
 * @see VMDeathEvent
 * @see EventQueue
 * @see VirtualMachine
