...
package consulo.internal.com.sun.tools.attach;

import consulo.internal.com.sun.tools.attach.spi.AttachProvider;
 ...
 * consulo.internal.com.sun.tools.attach.VirtualMachineDescriptor VirtualMachineDescriptor} obtained
 ...
 *      vm.loadAgent(agent, "consulo.internal.com.sun.management.jmxremote.port=5000");
 *
 *      // detach
 *      vm.detach();
 *
...
public abstract class VirtualMachine {
     ...
     * consulo.internal.com.sun.tools.attach.VirtualMachineDescriptor} elements.
     * The list is an aggregation of the virtual machine
     * descriptor lists obtained by invoking the {@link
     * consulo.internal.com.sun.tools.attach.spi.AttachProvider#listVirtualMachines
     * listVirtualMachines} method of all installed
     * {@link consulo.internal.com.sun.tools.attach.spi.AttachProvider attach providers}.
     ...
     * {@link consulo.internal.com.sun.tools.attach.spi.AttachProvider#providers()
     * AttachProvider.providers()} method. It then iterates overs the list
     * and invokes each provider's {@link
     * consulo.internal.com.sun.tools.attach.spi.AttachProvider#attachVirtualMachine(java.lang.String)
     ...
     * {@link consulo.internal.com.sun.tools.attach.AttachNotSupportedException AttachNotSupportedException}
     ...
     *          {@link consulo.internal.com.sun.tools.attach.AttachPermission AttachPermission}
     ...
     * consulo.internal.com.sun.tools.attach.VirtualMachineDescriptor#provider() provider()} method
     * of the given virtual machine descriptor to obtain the attach provider. It
     * then invokes the attach provider's {@link
     * consulo.internal.com.sun.tools.attach.spi.AttachProvider#attachVirtualMachine(VirtualMachineDescriptor)
     ...
     * an error then an {@link consulo.internal.com.sun.tools.attach.AgentInitializationException} is
     * thrown. The return value from the <code>Agent_OnAttach[_L]</code> can then be
     * obtained by invoking the {@link
     * consulo.internal.com.sun.tools.attach.AgentInitializationException#returnValue() returnValue}
     ...
     *
     * @see     consulo.internal.com.sun.tools.attach.AgentInitializationException#returnValue()
     */
