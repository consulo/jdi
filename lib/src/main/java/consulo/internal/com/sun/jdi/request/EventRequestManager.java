...
package consulo.internal.com.sun.jdi.request;
 ...
 *
 * @see EventRequest
 * @see consulo.internal.com.sun.jdi.event.Event
 * @see BreakpointRequest
 * @see consulo.internal.com.sun.jdi.event.BreakpointEvent
 * @see VirtualMachine
 *
 * @author Robert Field
 * @since  1.3
...
public interface EventRequestManager extends Mirror {
     ...
     * {@link consulo.internal.com.sun.jdi.event.ExceptionEvent#catchLocation} for
     * details.
     ...
     * A <code>size</code>value of {@link consulo.internal.com.sun.jdi.request.StepRequest#STEP_MIN} will generate a
     ...
     * level.
     * A <code>size</code> value of {@link consulo.internal.com.sun.jdi.request.StepRequest#STEP_LINE} will generate a
     ...
     * by a {@link consulo.internal.com.sun.jdi.VirtualMachine#redefineClasses} operation.
     * A <code>depth</code> value of {@link consulo.internal.com.sun.jdi.request.StepRequest#STEP_INTO} will generate
     * step events in any called methods.  A <code>depth</code> value
     * of {@link consulo.internal.com.sun.jdi.request.StepRequest#STEP_OVER} restricts step events to the current frame
     * or caller frames. A <code>depth</code> value of {@link consulo.internal.com.sun.jdi.request.StepRequest#STEP_OUT}
     ...
     * {@link consulo.internal.com.sun.jdi.event.VMDeathEvent}
     ...
     * will be suspended until the {@link consulo.internal.com.sun.jdi.event.EventSet}
     * containing the {@link consulo.internal.com.sun.jdi.event.VMDeathEvent}
     * is resumed.
     * <P>
     * Not all target virtual machines support this operation.
